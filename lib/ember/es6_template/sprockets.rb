...
module Ember
  module ES6Template
    def self.setup(env)
      ...
      env.register_mime_type 'text/coffeescript', extensions: %w(.es6.coffee js.coffee)
      env.register_mime_type 'text/coffeescript+module', extensions: %w(.module.es6.coffee .coffee)
